	<input type="hidden" name="objednavka" value="b">
	...
	<div class="col-3">
		<select name="triko" class="form-element">
	...
	<div class="col-2 checkitdiv">
		<textarea name="zpusobilost" class="form-element form-textarea" placeholder="Poznámky"></textarea>
